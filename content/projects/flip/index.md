...
date: 2022-05-13
description: "Fluid Simulation using FLIP + PIC"
summary: "Fluid Simulation using Fluid-Implicit Particles (FLIP) and Particle-In-Cell (PIC) methods"
...
Built a fluid simulation referencing methods from [Fluid Simulation Using Implicit Particles](http://www.danenglesson.com/images/portfolio/FLIP/rapport.pdf) and [Fluid Flow for the Rest of Us: Tutorial of the Marker and Cell Method inComputer Graphics](https://cg.informatik.uni-freiburg.de/intern/seminar/gridFluids_fluid_flow_for_the_rest_of_us.pdf). 
